...
from src.graphs.sagt_node_load_data import NodeName as LoadDataNodeName, load_welcome_message_node
from src.graphs.sagt_node_load_data import load_employee_info_node, load_tag_setting_node, load_customer_info_node, load_chat_history_node, load_kf_chat_history_node, load_order_history_node
...
## 加载数据节点（方案B：主图统一加载，子图按 input_schema 同名字段自动接收）
...
builder.add_node(LoadDataNodeName.LOAD_CUSTOMER_INFO.value, load_customer_info_node)    ## 加载客户信息（含 customer_profile / customer_tags）
